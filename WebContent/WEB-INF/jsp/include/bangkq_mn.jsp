...
<div class="page table-item txt-heading mb20 icon-list">
	...
	<c:if test="${lotterysMN!=null&&numSizeMN>0}">
		...
		<%  if(position != 1) {
		MetaGuide metaGuide = new MetaGuideDao().findByPosition(29);	
	
			
			String titleTemp = metaGuide.getTitle();
			
			String dateIndex = (String)request.getAttribute("ddmmyyyyMN");
	...
	<script type="application/ld+json">{
                  ...
                  "sameAs": "https://xosohn.com/xsmn-<%=version%>.html",
                  "keywords": [<%=keyword%>],
