        ...
        <div class="container">
            ...
            <%
                ...
                if("updateStatus".equals(action)){
                    ...
                    News888DAO dreamDao = new News888DAO();
                    ...
                    BigDecimal id = RequestUtil.getBigDecimal(request, "id", null);
                    News888DAO News888DAO = new News888DAO();
                    if(News888DAO.delete(id)){
                        %>
            ...
            <div class="content">
                <div class="formWrapper">
                    <h1>Quản lý chuyên mục soi cầu 888</h1>
                    <div style="margin-bottom: 5px;">
                        <a class="btnCMS" href="<%= request.getContextPath() %>/admin_news_888_create.htm">Thêm mới</a>
                    </div>
                    <div class="form1">
                        <%
                            int rowsPerPage = 10;
                        ...
                        <table class="info" style="width: 100%">
                            ...
                            <tr>
                                ...
                                <td><a href="<%= request.getContextPath() %>/soi-cau-888/<%=dream.getUrl() %>-<%=dream.getId() %>.html"><%= request.getContextPath() %>/soi-cau-888/<%=dream.getUrl() %>-<%=dream.getId() %>.html</a></td>
                                ...
                                <td>
                                    ...
                                    %>                                    
                                    | <a href="<%= request.getContextPath() %>/admin_news_888_update.htm?id=<%= dream.getId() %>">Sửa</a>
