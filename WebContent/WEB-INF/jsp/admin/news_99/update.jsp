	...
	color: green
						...
						if(!oldImage.endsWith(fileItem.getName()) && !CommonUtil.isEmptyString(fileItem.getName())) {
							...
							if ("update".equals(action)) {
								File fileRemove = new File(
										request.getServletContext().getAttribute("FILES_DIR5") + File.separator + oldImage);
		...
		<div class="content">
			<div class="formWrapper">
				<h1>Cập nhật chuyên mục soi cầu 99</h1>
				<div class="form1">
						...
						<table class="table-auto">
							...
							<tr>
								...
								<%
									...
									String filePath = request.getServletContext().getAttribute("FILES_DIR5") + File.separator + oldImageFile;
