        ...
        <div class="container">
            ...
            <%
                ...
                if("updateStatus".equals(action)){
                    ...
                    NewsDBDAO dreamDao = new NewsDBDAO();
                    ...
                    BigDecimal id = RequestUtil.getBigDecimal(request, "id", null);
                    NewsDBDAO NewsDBDAO = new NewsDBDAO();
                    if(NewsDBDAO.delete(id)){
                        %>
            ...
            <div class="content">
                <div class="formWrapper">
                    <h1>Quản lý Thống kê 2 số cuối giải đặc biệt</h1>
                    <div style="margin-bottom: 5px;">
                        <a class="btnCMS" href="<%= request.getContextPath() %>/admin_news_db_create.htm">Thêm mới</a>
                    </div>
                    <div class="form1">
                        <%
                            int rowsPerPage = 10;
                        ...
                        <table class="info" style="width: 100%">
                            ...
                            <tr>
                                ...
                                <td><a href="<%= request.getContextPath() %>/thong-ke-2-so-cuoi-giai-dac-biet/<%=dream.getUrl() %>-<%=dream.getId() %>.html"><%= request.getContextPath() %>/thong-ke-2-so-cuoi-giai-dac-biet/<%=dream.getUrl() %>-<%=dream.getId() %>.html</a></td>
                                ...
                                <td>
                                    ...
                                    %>                                    
                                    | <a href="<%= request.getContextPath() %>/admin_news_db_update.htm?id=<%= dream.getId() %>">Sửa</a>
