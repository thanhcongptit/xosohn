...
<title>Quản lý Thống kê 2 số cuối giải đặc biệt</title>
	...
	color: green
		...
		<%
			...
			try {
				...
				File filesDir = (File) getServletContext().getAttribute("FILES_DIR_FILE3");
						...
						if(!oldImage.endsWith(fileItem.getName()) && !CommonUtil.isEmptyString(fileItem.getName())) {
							...
							if ("update".equals(action)) {
								File fileRemove = new File(
										request.getServletContext().getAttribute("FILES_DIR3") + File.separator + oldImage);
								if(fileRemove.exists()) {
									fileRemove.delete();
								}
								
								File file1 = new File(
										request.getServletContext().getAttribute("FILES_DIR3") + File.separator + folderString);
								...
								File file = new File(
										request.getServletContext().getAttribute("FILES_DIR3") + File.separator  + fileName);
								fileItem.write(file);
							}
						} else {
							fileName = oldImage;
		...
		<div class="content">
			<div class="formWrapper">
				<h1>Cập nhật Thống kê 2 số cuối giải đặc biệt</h1>
				<div class="form1">
						...
						<table class="table-auto">
							...
							<tr>
								...
								<%
									...
									String filePath = request.getServletContext().getAttribute("FILES_DIR3") + File.separator + oldImageFile;
							...
							<tr>
								...
								<td><a
									href="<%=request.getContextPath()%>/admin/news_db/index.htm"
