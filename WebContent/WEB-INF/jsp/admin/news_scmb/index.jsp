        ...
        <div class="container">
            ...
            <%
                ...
                if("updateStatus".equals(action)){
                    ...
                    NewsSCMBDAO dreamDao = new NewsSCMBDAO();
                    ...
                    BigDecimal id = RequestUtil.getBigDecimal(request, "id", null);
                    NewsSCMBDAO NewsSCMBDAO = new NewsSCMBDAO();
                    if(NewsSCMBDAO.delete(id)){
                        %>
            ...
            <div class="content">
                <div class="formWrapper">
                    <h1>Quản lý chuyên mục soi cầu mb</h1>
                    <div style="margin-bottom: 5px;">
                        <a class="btnCMS" href="<%= request.getContextPath() %>/admin_news_scmb_create.htm">Thêm mới</a>
                    </div>
                    <div class="form1">
                        <%
                            int rowsPerPage = 10;
                        ...
                        <table class="info" style="width: 100%">
                            ...
                            <tr>
                                ...
                                <td><a href="<%= request.getContextPath() %>/soi-cau-mb/<%=dream.getUrl() %>-<%=dream.getId() %>.html"><%= request.getContextPath() %>/soi-cau-mb/<%=dream.getUrl() %>-<%=dream.getId() %>.html</a></td>
                                ...
                                <td>
                                    ...
                                    %>                                    
                                    | <a href="<%= request.getContextPath() %>/admin_news_scmb_update.htm?id=<%= dream.getId() %>">Sửa</a>
