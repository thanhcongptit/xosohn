	...
	color: green
		...
		<%
			...
			try {
				...
				File filesDir = (File) getServletContext().getAttribute("FILES_DIR_FILE2");
				...
				while (fileItemsIterator.hasNext()) {
					...
					if (fileItem.isFormField()) {
						...
						if (id != null) {
							DreamsDAO newsDAO = new DreamsDAO();
						...
						if(!oldImage.endsWith(fileItem.getName()) && !CommonUtil.isEmptyString(fileItem.getName())) {
							...
							if ("update".equals(action)) {
								File fileRemove = new File(
										request.getServletContext().getAttribute("FILES_DIR2") + File.separator + oldImage);
								if(fileRemove.exists()) {
									fileRemove.delete();
								}
								
								File file1 = new File(
										request.getServletContext().getAttribute("FILES_DIR2") + File.separator + folderString);
								...
								File file = new File(
										request.getServletContext().getAttribute("FILES_DIR2") + File.separator  + fileName);
								fileItem.write(file);
							}
						} else {
							fileName = oldImage;
						...
						<table class="table-auto">
							...
							<tr>
								...
								<%
									...
									String filePath = request.getServletContext().getAttribute("FILES_DIR2") + File.separator + oldImageFile;
							...
							<tr>
								...
								<td><a
									href="<%=request.getContextPath()%>/admin/dream/index.htm"
