        ...
        <div class="container">
            ...
            <%
                ...
                if("updateStatus".equals(action)){
                    ...
                    BigDecimal id = RequestUtil.getBigDecimal(request, "id", null);
                    NewsSCMBChinhXacDAO NewsSCMBChinhXacDAO = new NewsSCMBChinhXacDAO();
                    if(NewsSCMBChinhXacDAO.delete(id)){
                        %>
            ...
            <div class="content">
                <div class="formWrapper">
                    <h1>Quản lý chuyên mục soi cầu xsmb chính xác nhất </h1>
                    <div style="margin-bottom: 5px;">
                        <a class="btnCMS" href="<%= request.getContextPath() %>/admin_news_scmb_chinhxac_create.htm">Thêm mới</a>
                    </div>
                    <div class="form1">
                        <%
                            int rowsPerPage = 10;
                        ...
                        <table class="info" style="width: 100%">
                            ...
                            <tr>
                                ...
                                <td><a href="<%= request.getContextPath() %>/soi-cau-xsmb-chinh-xac-nhat/<%=dream.getUrl() %>-<%=dream.getId() %>.html"><%= request.getContextPath() %>/soi-cau-xsmb-chinh-xac-nhat/<%=dream.getUrl() %>-<%=dream.getId() %>.html</a></td>
                                ...
                                <td>
                                    ...
                                    %>                                    
                                    | <a href="<%= request.getContextPath() %>/admin_news_scmb_chinhxac_update.htm?id=<%= dream.getId() %>">Sửa</a>
