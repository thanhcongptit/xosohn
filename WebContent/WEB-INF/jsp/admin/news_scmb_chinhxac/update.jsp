...
<title>Quản lý chuyên mục soi cầu xsmb chính xác nhất </title>
	...
	color: green
		...
		<%
			...
			try {
				...
				File filesDir = (File) getServletContext().getAttribute("FILES_DIR_FILE7");
				...
				while (fileItemsIterator.hasNext()) {
					...
					if (fileItem.isFormField()) {
						...
						if (id != null) {
							NewsSCMBChinhXacDAO newsDAO = new NewsSCMBChinhXacDAO();
						...
						if(!oldImage.endsWith(fileItem.getName()) && !CommonUtil.isEmptyString(fileItem.getName())) {
							...
							if ("update".equals(action)) {
								File fileRemove = new File(
										request.getServletContext().getAttribute("FILES_DIR7") + File.separator + oldImage);
								if(fileRemove.exists()) {
									fileRemove.delete();
								}
								
								File file1 = new File(
										request.getServletContext().getAttribute("FILES_DIR7") + File.separator + folderString);
								...
								File file = new File(
										request.getServletContext().getAttribute("FILES_DIR7") + File.separator  + fileName);
								fileItem.write(file);
							}
						} else {
							fileName = oldImage;
		...
		<div class="content">
			<div class="formWrapper">
				<h1>Cập nhật chuyên mục soi cầu xsmb chính xác nhất </h1>
				<div class="form1">
						...
						<table class="table-auto">
							...
							<tr>
								...
								<%
									...
									String filePath = request.getServletContext().getAttribute("FILES_DIR7") + File.separator + oldImageFile;
							...
							<tr>
								...
								<td><a
									href="<%=request.getContextPath()%>/admin/news_scmb_chinhxac/index.htm"
