...
function handelCodeChangeSoiCau() {
	...
	var url = "${pageContext.servletContext.contextPath}/"
			+ "thong-ke-lo-kep-" + fields[0].toLowerCase() + "-" + fields[1].toLowerCase()
			+ ".html";
					...
					<div class="col-xs-12 col-sm-6 col-s">
						...
						<div class="content">
							<div class="page txt-heading mb20 parent-list">
								<h1>THỐNG KÊ LÔ KÉP ${fn:toUpperCase(lotteryCompany.code)}</h1>
								
								<%@include file="include/option_thongke.jsp"%>
								
							</div>
							
							<%@include file="include/tk_loto_kep.jsp"%>
							
							<div class="page txt-heading mb20 parent-list">
								<h2>THỐNG KÊ LÔ GAN ${fn:toUpperCase(lotteryCompany.code)}</h2>
