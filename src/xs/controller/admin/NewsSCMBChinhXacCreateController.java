 ...
 * @author hanhlm
 */
public class NewsSCMBChinhXacCreateController extends BaseController {
    
    public NewsSCMBChinhXacCreateController() {
    }
    ...
    protected ModelAndView handleRequestInternal(
        ...
        mod.setViewName("/admin/news_scmb_chinhxac/create");
